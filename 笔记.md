...
- java类型信息（Class）对象与反射机制，[参考](https://blog.csdn.net/javazejian/article/details/70768369)
  ...
  - 类加载
    ...
    ![load class](C:\Users\Administrator\Desktop\git\learningNote\img\类加载过程.png)
...
- Java并发之synchronized实现原理[参考](https://blog.csdn.net/javazejian/article/details/73413292)
